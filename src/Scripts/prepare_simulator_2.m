function prepare_simulator_2(options)
%% Init file for MOBATSim    
    ...
    arguments
        ...
        options.modelName           (1,1) string    = 'MOBATSim_fault_free'            % Name of the simulink model
        ...
        options.scenarioName        (1,1) string    = 'Road Merge Collision'% Scenario sets start points, destination points and maxSpeeds
